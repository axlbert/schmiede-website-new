...
image="app"
tag="schmiede_website"
aws_tag="schmiede_website"
...
ecs-cli compose service --cluster-config schmiede_website stop

echo "Creating and starting service..."
TAGGED_IMAGE=${tagged_image} ecs-cli compose service --cluster-config schmiede_website up